...
const Login = props => {
  ...
  return (
    <div className={(props.loginPopup) ? "Login Login-popup" : "Login"}>
      ...
      <h3 className="Login-header">Log in
      ...
      <form className="Login-form" onSubmit={logUserDataIn}>
        ...
        <input
          ...
          className={(loginNameWarning) ? "Login-form-textInput Warning" : "Login-form-textInput"} />
        ...
        <input
          ...
          className={(loginPasswordWarning) ? "Login-form-textInput Warning" : "Login-form-textInput"} />
        ...
        <ul className="Login-form-warningList">
          <li className="Login-form-warningItem">{!(loginNameWarning || loginPasswordWarning) ?
