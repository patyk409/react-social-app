...
const Signup = (props) => {
  ...
  const formValidation = (event) => {
    ...
    if (
      !passwordValidation.test(signupPassword) ||
  ...
  return (
    <div className="Signup">
      ...
      <form className="Signup-form" onSubmit={signUserDataUp}>
        ...
        <label className="Signup-form-label" htmlFor="Confirm">
          Confirm:
        </label>
        <input
          id="Confirm"
        ...
        <ul className="Signup-form-warningList">
          <li className="Signup-form-warningItem">
            {!(signupNameWarning || signupEmailWarning || signupPasswordWarning)
        ...
        <Link className="Signup-form-redirectionLink" to="/login">
          Log in
        </Link>
      </form>

      <div className="Closer">
        <Link className="Closer-link" to="/">
