  ...
  return (
    <aside className="Dashboard">
      ...
      <div className="Dashboard-profile">
        ...
        <h3 className="Dashboard-header">Your profile
          <i className="far fa-id-card Dashboard-headerIcon"></i>
        </h3>

        <div className="Dashboard-profile-data">
          <img src={props.profileAvatar} alt="profile_avatar" className="Dashboard-profile-data-avatar" />
        ...
        <div className="Dashboard-inputBox">
              ...
              <ul className="Dashboard-searchedPostResult-list">
                ...
                {props.searchedPostResult.length === 0 ?
                  <div className="Dashboard-searchedPostResult-infoBox">
                    <p className="Dashboard-searchedPostResult-info">{props.searchedPostInfo}</p>
                  </div> :
                  props.searchedPostResult.map(post => {
                    return (
                      <li className="Dashboard-searchedPostResult-listItem" key={post.id}>
                        <div className="Dashboard-searchedPostResult-listItem-author">
                          <img src={post.user.avatar_url} alt="user_avatar" className="Dashboard-searchedPostResult-listItem-author-avatar" />

                          <div className="Dashboard-searchedPostResult-listItem-author-data">
                            <p className="Dashboard-searchedPostResult-listItem-author-data-name">{post.user.username}</p>
                            <span className="Dashboard-searchedPostResult-listItem-author-data-timeAgo">{moment(post.created_at).fromNow()}</span>
                          </div>

                          <div className="Dashboard-searchedPostResult-listItem-likeBox">
                            <span className="Dashboard-searchedPostResult-listItem-likeBox-likeAmount">{post.likes.length}</span>

                            <i className={post.likes.filter(like => like.username === localStorage.getItem("name")).length > 0 ? "far fa-heart Dashboard-searchedPostResult-listItem-likeBoxIcon Post-liked" : "far fa-heart Dashboard-searchedPostResult-listItem-likeBoxIcon"} onClick={(event) => {
                        ...
                        <p className="Dashboard-searchedPostResult-listItem-postContent">{post.content}</p>
                      </li>
                    )
                  })}
          ...
          {props.searchedPostTrigger ?
            <div className="Dashboard-searchedPostResult-closer" onClick={() => { props.searchedPostCloser() }}>
      ...
      <div className="Dashboard-users">
        ...
        <h3 className="Dashboard-header">You may follow
        ...
        <ul className="Dashboard-users-recommendedUsersList">
          {props.recommendedUsers.map(user => {
            return (
              <li className="Dashboard-users-recommendedUsersItem" key={user.id}>
                <img src={user.avatar_url} alt="user_avatar" className="Dashboard-users-recommendedUsersItem-avatar" />
                <div className="Dashboard-users-recommendedUsersItem-data">
                  <p className="Dashboard-users-recommendedUsersItem-data-name">{user.username}</p>
                  <p className="Dashboard-users-recommendedUsersItem-data-email">{user.email}</p>
                </div>

                <div className="FollowIcon" onClick={() => { props.followUser(user.id) }} tabIndex="0">
        ...
        <h3 className="Dashboard-header">Social Club
            ...
            <div className="Dashboard-searchedUserResult">
              ...
              {!props.searchedUserInfo ?
                <div className="Dashboard-searchedUserResult-user">
                  <img src={props.searchedAvatar} alt="user_avatar" className="Dashboard-searchedUserResult-user-avatar" />
                  <div className="Dashboard-searchedUserResult-user-data">
                    <p className="Dashboard-searchedUserResult-user-data-name">{props.searchedName}</p>
                    <p className="Dashboard-searchedUserResult-user-data-email">{props.searchedEmail}</p>
                  </div>

                  <div className="FollowIcon" onClick={() => { props.followUser(props.searchedUserId) }} tabIndex="0">
              ...
              {props.searchedUserInfo ?
                <div className="Dashboard-searchedUserResult-infoBox">
                  <p className="Dashboard-searchedUserResult-info">{props.searchedUserInfo}</p>
                </div> : null}
            </div> : null}

          {props.searchedUserTrigger ?
            <div className="Dashboard-searchedUserResult-closer" onClick={() => { props.setSearchedUserTrigger(false) }}>
